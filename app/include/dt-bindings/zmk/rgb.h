...
#define RGB_TOG_BAT_LEFT_CMD 15
#define RGB_TOG_BAT_RIGHT_CMD 16
...
#define RGB_TOG_BAT_LEFT RGB_TOG_BAT_LEFT_CMD 0
#define RGB_TOG_BAT_RIGHT RGB_TOG_BAT_RIGHT_CMD 0
